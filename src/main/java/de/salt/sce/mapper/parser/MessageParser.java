...
public class MessageParser {
    ...
    public Optional<String> parseFile(
        ...
        try {
            ...
            log.error("Error by parsing a file in mapper. The The error is generated by the MessageParser class function parseFile. For detailed information, please check the info log.");
